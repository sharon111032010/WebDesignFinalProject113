const feedback = [
    ...
    { name:"林美玲", contryC:"臺灣 嘉義市", contryE: "Chiayi, Taiwan", image: "img/index/female_5.png", article: "領養這隻金魚讓我重新找回了心中的溫暖與平靜。牠的自由游動讓我學會如何放下壓力，專注於當下的每一刻。透過與牠的陪伴，我明白了愛與陪伴不一定是言語，而是存在於心與心之間的默契。"}
]
